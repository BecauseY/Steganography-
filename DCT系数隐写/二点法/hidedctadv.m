...
%修改时间：2004.3.8
%函数功能：本函数用于DCT域的信息隐藏
%输入格式举例：[count,msg,data,result]=hidedctadv('girl.jpg','embed2.jpg','secret.txt',2019,1);
%参数说明：
%image为载体图象
...
%count为待隐藏信息的长度
%result为隐藏结果
function [count,msg,data,result,DCTrgb]=hidedctadv(image,imagegoal,msg,key,alpha)
%按位读取秘密信息
frr=fopen(msg,'r');
