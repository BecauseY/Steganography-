%输入格式举例:[watermarkimagergb,watermarkimage,waterCA,watermark]=dwtspread('girl.jpg','girlwsvd.png',52,'db6',2,0.1)
...
CA1=(CAmax1-CAmin1)*CA1CA1+CAmin;%系数还原到归一化以前的范围
...
figure(1);
subplot(321),imshow(logobmp_ori);title('原水印图像');
subplot(322);imshow(watermark2*255);title('产生的水印形态');
